...
class TOBAFViewController: UIViewController,PenviewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        googleAnalyticsTrackingWith(trackingName: "Toba F Chronic Allergic Conjunctivitis")
    ...
    @IBAction func referenceAction(_ sender: Any) {
        let popImage = UIImage(named: "tobaF_popup_new")
        let buttonImage = UIImage(named: "tobaF_close")
