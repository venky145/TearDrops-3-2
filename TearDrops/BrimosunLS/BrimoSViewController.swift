...
class BrimoSViewController: UIViewController,PenviewDelegate {
    ...
    @IBAction func referenceAction(_ sender: Any) {
        let popImage = UIImage(named: "bls_popup_new")
        let buttonImage = UIImage(named: "bls_close")
