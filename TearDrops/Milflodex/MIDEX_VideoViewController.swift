//
//  MIDEX_VideoViewController.swift
//  TearDrops
//
...
import UIKit
import AVKit
class MIDEX_VideoViewController: UIViewController {
let playerController = AVPlayerViewController()
    ...
    func moveToNextViewController(){
        let newViewController = setupStoryBoard(storyBoardName: "Milflodex").instantiateViewController(withIdentifier: "MDEX_FirstViewController") as! MDEX_FirstViewController
        moveToViewController(nextVC: newViewController,for: self)
    }
