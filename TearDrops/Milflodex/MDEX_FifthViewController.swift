//
//  MDEX_FifthViewController.swift
//  TearDrops
//
...
class MDEX_FifthViewController: UIViewController,PenviewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        googleAnalyticsTrackingWith(trackingName: "Milflodex Cataract & LASIK Surgery No BKC Side Effects")
