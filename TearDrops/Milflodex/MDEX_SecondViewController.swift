//
//  MDEX_SecondViewController.swift
//  TearDrops
//
...
class MDEX_SecondViewController: UIViewController,PenviewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        googleAnalyticsTrackingWith(trackingName: "Milflodex Cataract & LASIK Surgery BKC Free")
    ...
    func moveToNextViewController(){
        let newViewController = setupStoryBoard(storyBoardName: "Milflodex").instantiateViewController(withIdentifier: "MDEX_ThirdViewController") as! MDEX_ThirdViewController
