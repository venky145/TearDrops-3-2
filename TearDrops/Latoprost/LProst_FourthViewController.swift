//
//  LProst_FourthViewController.swift
//  TearDrops
//
...
class LProst_FourthViewController: UIViewController,PenviewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        googleAnalyticsTrackingWith(trackingName: "Latoprost RT Glaucoma Medication & Hyperemia  ")
