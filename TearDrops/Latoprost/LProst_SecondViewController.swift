//
//  LProst_SecondViewController.swift
//  TearDrops
//
...
class LProst_SecondViewController: UIViewController,PenviewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        googleAnalyticsTrackingWith(trackingName: "Latoprost RT Glaucoma SMM Technology Micelle ")
