//
//  LProst_FirstViewController.swift
//  TearDrops
//
...
class LProst_FirstViewController: UIViewController,PenviewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        googleAnalyticsTrackingWith(trackingName: "Latoprost RT Glaucoma SMM Technology")
    ...
    func moveToNextViewController(){
        let newViewController = setupStoryBoard(storyBoardName: "Latoprost").instantiateViewController(withIdentifier: "LProst_SecondViewController") as! LProst_SecondViewController
    ...
    @IBAction func thirdAction(_ sender: UIButton) {
        let newViewController = setupStoryBoard(storyBoardName: "Latoprost").instantiateViewController(withIdentifier: "LProst_ThirdViewController") as! LProst_ThirdViewController
        moveToViewController(nextVC: newViewController,for: self)
    }
    @IBAction func fourthAction(_ sender: UIButton) {
        let newViewController = setupStoryBoard(storyBoardName: "Latoprost").instantiateViewController(withIdentifier: "LProst_FourthViewController") as! LProst_FourthViewController
        moveToViewController(nextVC: newViewController,for: self)
    }
    
    @IBAction func fifthAction(_ sender: UIButton) {
        let newViewController = setupStoryBoard(storyBoardName: "Latoprost").instantiateViewController(withIdentifier: "LProst_FifthViewController") as! LProst_FifthViewController
        moveToViewController(nextVC: newViewController,for: self)
    }
    @IBAction func sixthAction(_ sender: UIButton) {
        let newViewController = setupStoryBoard(storyBoardName: "Latoprost").instantiateViewController(withIdentifier: "LProst_SixthViewController") as! LProst_SixthViewController
        moveToViewController(nextVC: newViewController,for: self)
    }
