//
//  LProst_ThirdViewController.swift
//  TearDrops
//
...
class LProst_ThirdViewController: UIViewController,PenviewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        googleAnalyticsTrackingWith(trackingName: "Latoprost RT Glaucoma vs. Competition")
