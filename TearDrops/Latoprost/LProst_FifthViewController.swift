//
//  LProst_FifthViewController.swift
//  TearDrops
//
...
class LProst_FifthViewController: UIViewController,PenviewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        googleAnalyticsTrackingWith(trackingName: "Latoprost RT Glaucoma vs. Competition Tolerability")
