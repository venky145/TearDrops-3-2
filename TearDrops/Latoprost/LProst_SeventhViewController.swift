//
//  LProst_SeventhViewController.swift
//  TearDrops
//
...
class LProst_SeventhViewController: UIViewController,PenviewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        googleAnalyticsTrackingWith(trackingName: "Latoprost RT Glaucoma Overall Benefits")
...
//    }
    func moveToPrevious(){
        moveToPreviousViewController(currentVC: self, at: 7)
    }
