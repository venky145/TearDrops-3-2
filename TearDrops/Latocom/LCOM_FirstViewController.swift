//
//  LCOM_FirstViewController.swift
//  TearDrops
//
...
class LCOM_FirstViewController: UIViewController,PenviewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        googleAnalyticsTrackingWith(trackingName: "Latocom CF Glaucoma GFR Technology")
    ...
    func moveToNextViewController(){
        let newViewController = setupStoryBoard(storyBoardName: "Latocom").instantiateViewController(withIdentifier: "LCOM_SecondViewController") as! LCOM_SecondViewController
    ...
    @IBAction func thirdAction(_ sender: UIButton) {
        let newViewController = setupStoryBoard(storyBoardName: "Latocom").instantiateViewController(withIdentifier: "LCOM_ThirdViewController") as! LCOM_ThirdViewController
        moveToViewController(nextVC: newViewController,for: self)
    }
