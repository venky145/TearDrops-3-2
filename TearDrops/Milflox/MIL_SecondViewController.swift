//
//  MIL_SecondViewController.swift
//  TearDrops
//
...
class MIL_SecondViewController: UIViewController,PenviewDelegate {
    @IBOutlet weak var subHeadImage: UIImageView!
