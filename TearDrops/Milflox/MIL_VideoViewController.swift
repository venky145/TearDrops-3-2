...
import UIKit
import AVKit
class MIL_VideoViewController: UIViewController {
let playerController = AVPlayerViewController()
    ...
    func moveToNextViewController(){
        let newViewController = setupStoryBoard(storyBoardName: "Milflox").instantiateViewController(withIdentifier: "MIL_FirstViewController") as! MIL_FirstViewController
        moveToViewController(nextVC: newViewController,for: self)
    }
