...
class MIL_ThirdViewController: UIViewController,PenviewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        googleAnalyticsTrackingWith(trackingName: "Milflox Pre & Post Surgical Prophylaxis Limits Second Mutation")
