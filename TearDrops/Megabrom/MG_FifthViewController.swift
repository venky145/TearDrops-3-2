...
class MG_FifthViewController: UIViewController,PenviewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        googleAnalyticsTrackingWith(trackingName: "Megabrom Anti-VEGF Adjuvant")
