//
//  BRIMO_FirstViewController.swift
//  TearDrops
//
...
class BRIMO_FirstViewController: UIViewController,PenviewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        googleAnalyticsTrackingWith(trackingName: "Brimolol Open Angle Glaucoma & Ocular Hypertension Benefits")
    ...
    func moveToNextViewController(){
        let newViewController = setupStoryBoard(storyBoardName: "Brimolol").instantiateViewController(withIdentifier: "BRIMO_SecondViewController") as! BRIMO_SecondViewController
    ...
    @IBAction func thirdAction(_ sender: UIButton) {
        let newViewController = setupStoryBoard(storyBoardName: "Brimolol").instantiateViewController(withIdentifier: "BRIMO_ThirdViewController") as! BRIMO_ThirdViewController
        moveToViewController(nextVC: newViewController,for: self)
    }
    @IBAction func fourthAction(_ sender: UIButton) {
        let newViewController = setupStoryBoard(storyBoardName: "Brimolol").instantiateViewController(withIdentifier: "BRIMO_FourthViewController") as! BRIMO_FourthViewController
        moveToViewController(nextVC: newViewController,for: self)
    }
    
    @IBAction func fifthAction(_ sender: UIButton) {
        let newViewController = setupStoryBoard(storyBoardName: "Brimolol").instantiateViewController(withIdentifier: "BRIMO_FifthViewController") as! BRIMO_FifthViewController
        moveToViewController(nextVC: newViewController,for: self)
    }
    @IBAction func sixthAction(_ sender: UIButton) {
        let newViewController = setupStoryBoard(storyBoardName: "Brimolol").instantiateViewController(withIdentifier: "BRIMO_SixthViewController") as! BRIMO_SixthViewController
        moveToViewController(nextVC: newViewController,for: self)
    }
    ...
    @IBAction func referenceAction(_ sender: Any) {
        let popImage = UIImage(named: "br_popup_new")
        let buttonImage = UIImage(named: "br_close")
