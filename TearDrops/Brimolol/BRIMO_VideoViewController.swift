//
//  BRIMO_VideoViewController.swift
//  TearDrops
//
...
import UIKit
import AVKit
class BRIMO_VideoViewController: UIViewController {
    ...
    func moveToNextViewController(){
        let newViewController = setupStoryBoard(storyBoardName: "Brimolol").instantiateViewController(withIdentifier: "BRIMO_FirstViewController") as! BRIMO_FirstViewController
        moveToViewController(nextVC: newViewController,for: self)
    }
