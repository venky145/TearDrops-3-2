//
//  MPLUS_SecondViewController.swift
//  TearDrops
//
...
class MPLUS_SecondViewController: UIViewController ,PenviewDelegate{
    ...
    override func viewWillAppear(_ animated: Bool) {
        googleAnalyticsTrackingWith(trackingName: "Milflox Plus Pre & Post Surgery Cataract Refractive")
        self.v1.alpha = 1
        self.v2.alpha = 1
        self.v3.alpha = 1
        self.v4.alpha = 1
