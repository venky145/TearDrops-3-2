//
//  GEye_FirstViewController.swift
//  TearDrops
//
...
class GEye_FirstViewController: UIViewController ,PenviewDelegate{
    ...
    func moveToNextViewController(){
        let newViewController = setupStoryBoard(storyBoardName: "Gloeye").instantiateViewController(withIdentifier: "GEye_SecondViewController") as! GEye_SecondViewController
